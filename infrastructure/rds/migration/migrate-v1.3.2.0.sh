...
alias migrate="psql -h $PGHOSTNAME -p 5432 -U $PGUSERNAME -d $PGDATABASE -c "

migrate "\copy keyword(id,name,definition) FROM './data/v1_3_2/keyword.csv' CSV HEADER"
...
migrate "\copy faction_variant_rule(id,faction_variant_id,name,rule) FROM './data/v1_3_2/faction_variant_rule.csv' CSV HEADER"
...
migrate "\copy upgrade(id,cost,currency,min,max,name) FROM './data/v1_3_2/upgrade.csv' CSV HEADER"
migrate "\copy upgrade_rule(upgrade_id,faction_variant_rule_id) FROM './data/v1_3_2/upgrade_rule.csv' CSV HEADER"
migrate "\copy upgrade_modifier(upgrade_id,type,value) FROM './data/v1_3_2/upgrade_modifier.csv' CSV HEADER"
...
migrate "\copy troop_type_upgrade(upgrade_id,troop_type_id,faction_variant_id) FROM './data/v1_3_2/troop_type_upgrade.csv' CSV HEADER"
